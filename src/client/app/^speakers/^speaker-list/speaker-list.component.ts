...
import { Speaker, SpeakerService, SortSpeakersPipe } from '../common';
import { SpeakerButtonComponent } from '../speaker-button';
import { FilterService, FilterTextComponent } from '../../common';
