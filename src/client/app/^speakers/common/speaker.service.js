System.register(['angular2/core', 'angular2/http', '../../common'], function(exports_1, context_1) {
    ...
    var speakersUrl, SpeakerService;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            speakersUrl = common_1.CONFIG.baseUrls.speakers;
            SpeakerService = (function () {
                function SpeakerService(_http, _exceptionService, _messageService, _spinnerService) {
                    var _this = this;
                    this._http = _http;
                    ...
                    this._messageService.state.subscribe(function (state) { return _this.getSpeakers(); });
                }
